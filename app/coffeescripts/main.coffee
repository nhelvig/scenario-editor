# Originating load file: main.html.  This set of functions and
# collections is used to load all the javascript classes and libraries
# into memory.  It also instantiates the AppView class and begin the
# rendering process.
...
window.load_sirius = ->
  head.js "js/Sirius.js",
          ...
          'js/sirius-classes-load.js', ->
            load_sirius_classes ->
               # static instance level event aggegator that most
