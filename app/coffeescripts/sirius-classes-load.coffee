...
$a.sirius_map_view_classes = [
  'AppView', 'ContextMenuItemView','ContextMenuView', 'EditorView',  'EditorNodeView', 'EditorSensorView', 'FileUploadView', 
  'LayersMenuView', 'LayersMenuViewItem', 'MapLinkView', 'MapMarkerView', 'MapNetworkView', 'MapNodeView', 'MapSensorView', 
  'MapControllerView', 'MapEventView', 'MapSignalView', 'Util', 'MessagePanelView', 'TreeView', 'TreeParentItemView', 'TreeChildItemView', 
