...
<scenario>\
  ...
  <NetworkList>\
    <network dt="300">\
      <description/>\
      <position>\
        <point lat="37.87052887198836" lng="-122.29921032142636" elevation="0"/>\
      </position>\
      <NodeList>\
        <node type="" id="9999">\
          <roadway_markers>\
      ...
      <LinkList>\
        ...
        <link lanes="1" lane_offset="0" length="1091.590020088609" type="" id="10000" in_sync="true">\
          <begin node_id="10000"/>\
          <end node_id="9999"/>\
          <roads>\
            <road name=""/>\
          ...
          <dynamics type="CTM"/>\
          <shape>szafFrzliVIBaJpBqE`AkAZ_ATkAVuE`AyDbAy@RQDuCj@YFqAVu@Pa@HaDt@OBo@NWDe@J</shape>\
        </link>\
      </LinkList>\
      <IntersectionCache/>\
    </network>\
