class window.beats.ODDemandPofileSet extends Backbone.Model
  ...
  @from_xml2: (xml, deferred, object_with_id) ->
    ...
    obj = new window.beats.ODDemandPofileSet()
  ...
  to_xml: (doc) ->
    xml = doc.createElement('ODDemandPofileSet')
  ...
  deep_copy: -> ODDemandPofileSet.from_xml1(@to_xml(), {})
