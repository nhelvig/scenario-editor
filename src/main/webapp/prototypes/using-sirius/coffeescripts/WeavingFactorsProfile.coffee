class window.beats.WeavingFactorsProfile extends Backbone.Model
  ...
  @from_xml2: (xml, deferred, object_with_id) ->
    ...
    obj = new window.beats.WeavingFactorsProfile()
  ...
  to_xml: (doc) ->
    xml = doc.createElement('WeavingFactorsProfile')
  ...
  deep_copy: -> WeavingFactorsProfile.from_xml1(@to_xml(), {})
